...
const DogCard = (props) => {
    return (
        <div>
            <Card>
                <CardImg top width="100%" src="https://placeholdit.imgix.net/~text?txtsize=33&txt=318%C3%97180&w=318&h=180" /*{props.dogData.image}*/ alt="Card image cap" />
                <CardBody>
                    {/* don't know if these props work properly need data to test */}
                    <CardTitle>{/* Dog Name */}{props.dogData.name}</CardTitle>
                    <CardText>
												<ul class="fa-ul">
