 ...
 return (
   <div>
     <Container>
       <Row>
         <Col md="auto">
           <img className="shelterImg" src={props.shelterJSON.image_urls.length > 0 ? props.shelterJSON.image_urls[0] : "/static/img/homeswehomelogo.svg"}/>
         </Col>
         <Col>
           ...
           <span className="text-muted">Phone:
              <span className="shelterPhone"> {props.shelterJSON.phone == null || props.shelterJSON.phone == "" ? "N/A" : props.shelterJSON.phone}</span>
           </span>
           <br/>
